...
const Index = () => {
	...
	const faqData = [
		{
			question: "Comment fonctionne DigiFrams ?",
			answer:
				"DigiFrams connecte les producteurs locaux avec des acheteurs potentiels grâce à des solutions technologiques innovantes. Les utilisateurs peuvent s'inscrire pour accéder à des services variés.",
		},
		{
		...
		{
			question: "Quels sont les avantages d'utiliser DigiFrams ?",
			answer:
				"DigiFrams permet aux producteurs de vendre leurs produits plus facilement, tout en offrant aux acheteurs une large gamme de produits locaux de qualité.",
		},
	];
					...
					<div className="container-fluid">
						<div className="rowtop_1 d-flex align-items-center">
							<div className="text-content">
								...
								<h1>Bienvenue sur DigiFrams</h1>
								<p>
									DigiFrams est une plateforme qui connecte les acteurs du secteur agricole sénégalais à travers des solutions technologiques innovantes. Elle vise à moderniser l&apos;agriculture et à promouvoir une croissance durable au service des producteurs locaux.
								</p>
								<NavLink to="/contact">
						...
						<div className='container_un'>
							...
							<div className='section_description'>
								<div className='titreApropos'>
									...
									<h6>À propos de DigiFrams</h6>
								</div>
								<h1>Améliorer la production agricole au sénégal</h1>
								<div className='descriptionApropos'>
									<div className='trh2'></div>
									<p>DigiFrams est une initiative dédiée à la transformation du secteur agricole sénégalais à travers l&apos;intégration de la technologie. Nous accompagnons les agriculteurs, les coopératives, et les investisseurs en offrant
						...
						<div className="learn_1 row">
										...
										<div className="learn_1l2i row">
											...
											<div className="col-md-9 col-9">
												<div className="learn_1l2ir">
													...
													<h5 className="text-light">Par Équipe de DigiFrams</h5>
							...
							<div className="col-md-6">
								<div className="learn_1r mt-4">
									...
									<p className="mt-6">hez DigiFrams, nous révolutionnons le secteur agricole en combinant innovation technologique et
